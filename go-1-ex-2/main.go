...
func main() {
	...
	var marathonInMiles = marathonInKM / mileInKM // Berechnung der Marathon-Distanz in Meilen
	fmt.Printf("a marathon is %.2f kilometres = %.2f miles long\n", marathonInKM, marathonInMiles)

	var boilingWaterCelsius = 100.0
	var boilingWaterFahrenheit = boilingWaterCelsius*9/5 + 32 // Berechnung der Siedetemperatur in Fahrenheit
